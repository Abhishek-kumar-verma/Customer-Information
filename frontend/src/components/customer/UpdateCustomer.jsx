...
const UpdateCustomer = () => {
    ...
    const onSubmitBtn = async (e) => {
        ...
        if(tenant && city && name && contact_email && country && state && zip && contact_phone.length && violation_category.length >= 1 ){
            const response = await axios.put(`http://localhost:8035/updateCustomer/${id}`, {
                name: name,
            ...
            alert(`Customer update whose id is ${id}`)
            ...
            violation_category+""+contact_email+
            ""+contact_phone+""+is_active+""+tenant+""+zip);
        }
    ...
    const loadDetails = async () => {
        ...
        const getCust = await axios.get(`http://localhost:8035/getCustomerById/${id}`);
        setInitialValue(await getCust.data);
        console.log(await getCust.data);
    ...
    const setInitialValue = (obj) => {
        // setAddress(obj.address);
        // setName(obj.name);
        // setContact_Email(obj.contact_email);
        // setContact_Phone(obj.contact_phone);
            ...
            <div className='container mt-4 .bg-dark.bg-gradient'>
                <div className='row'>
                    <div className='col-md-13 offset-md-0.5 border rounded p-2 mt-2 shadow'>
                        <h3 className='text-centre m-4'>UPDATE CUSTOMER</h3>
                        <form className="row center-block" onSubmit={(e) => onSubmitBtn(e)}>
                            <div className='col-md-5 mx-4'>
                                <div className="mb-3 row p-1">
                                    ...
                                    <select type="text" className="form-select" id="inputTenant" onChange={(e) => setTenant(e.target.value)} >
                            ...
                            <div className='col-md-6 '>
                                ...
                                <div className="mb-3 row p-1">
                                    ...
                                    <div className="col-sm-10">
                                        <input className="form-control" name="contact_email" value={contact_email} id="inputContantEmail" onChange={(e) => setContact_Email(e.target.value)}  />
                                ...
                                <div className='mb-3 row '>
                                    <label for="checkActive" className='col-sm-2 col-form-label'>Is Active</label>
                            ...
                            <div>
                                <button type="submit" className="btn btn-dark m-3">Update</button>
